...
public class Inventory2 : MonoBehaviour
{
    ...
    public PlayerMovementLevel2 playerMovement;
    ...
    void Update()
    {
        ...
        if(gc2 != null)
        if (waila.currentObject != null && Input.GetKeyDown(gc2.pickupKey))
        {
        ...
        if(gc2 != null)
        {
            if (Input.GetKeyDown(gc2.throwKey) && isHoldingWeapon)
            {
                ThrowWeapon(currentHeldWeapon);
            }
            else if (Input.GetKeyDown(gc2.throwKey) && isHoldingItem)
            {
    ...
    public void HoldGun()
    {
        ...
        GetComponent<BoxCollider>().center = new Vector3(0f, 0f, .79f);
    ...
    {
        if (myInventory[i].GetComponent<ColliderEnable2>() != null)
            myInventory[i].GetComponent<ColliderEnable2>().disableCollider = true;
