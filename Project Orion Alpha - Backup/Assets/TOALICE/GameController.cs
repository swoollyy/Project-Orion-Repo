...
public class GameController : MonoBehaviour
{
    ...
    bool doOnce4 = false;
    bool doOnce5 = false;
    bool doOnceLizardPosition = false;
    ...
    public LizardStateController firstLizard;

    public AudioMixerSnapshot fieldSnapshot;
    public AudioMixerSnapshot dustSnapshot;
    ...
    void Start()
    {
        ...
        firstLizard.enabled = false;
        crossHair.enabled = false;
        indicatorUI.enabled = false;
        objectiveText.enabled = false;
        questHelperText.enabled = false;
    ...
    void Update()
    {
        ...
        if (scorpController.lizardInPosition)
        {
            if (!doOnceLizardPosition)
            {
                tutText.text = "";
                currentCharacter = 0;
                delayTimer = 5f;
        ...
        if(textCounter == 3)
        {
            questHelperText.text = "Find and kill a Sang-Sang";
        }
        if (textCounter == 6)
        {
            questHelperText.text = "Locate a lizards nest and approach with Wistiria, the local fruit";
        }
        if (textCounter == 10)
        {
            questHelperText.text = "Kill the lizard. Tame it if you please";
        }
        if (textCounter == 12)
        {
            questHelperText.text = "Carry the lizard underneath a large rock structure. Avoid hazards along the way";
        }
        if (textCounter == 14)
        {
            questHelperText.text = "Wait for the scorpion to come out";
        }
        if (textCounter == 15)
        {
            questHelperText.text = "Extract a blood sample with your knife";
        }
        if (textCounter == 16)
        {
            questHelperText.text = "Board your ship";
        }
    ...
    public void GlobalEvents()
    {
        ...
        dustSnapshot.TransitionTo(1.3f);
        Camera.main.farClipPlane = 64f;
    ...
    public void EndGlobalEvents()
    {
        ...
        fieldSnapshot.TransitionTo(1.3f);
