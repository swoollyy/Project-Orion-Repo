...
public class DoorOpener : MonoBehaviour
{
    ...
    {
        if(col.gameObject.tag == "Player" && (tutorialStateMachine.currentState == tutorialStateMachine.secondRoomState || tutorialStateMachine.currentState == tutorialStateMachine.fieldState))
        {
            closeDoor = false;
            OpenDoor();
        }
